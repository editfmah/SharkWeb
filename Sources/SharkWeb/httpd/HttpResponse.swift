...
public enum HttpResponse {
    ...
    public func headers() -> [String: String] {
        ...
        case .movedTemporarily(let location):
            headers["Location"] = location
        case .redirect(let location, let cookie):
            headers["Location"] = location
            if cookie == nil {
                headers["Set-Cookie"] = "AuthToken=; Path=/; expires;"
            } else {
                headers["Set-Cookie"] = "\(cookie!.compiled()) Path=/; expires;"
            }
